...
const Step4: React.FC<Props> = ({ nextStep, prevStep, formData, update }) => {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold mb-4">Emisyon ve Süreç Verileri</h2>

      {/* Üretim Süreci */}
      <div className="mb-4">
        <label className="block font-medium mb-1">Üretim Süreci Türü</label>
        <select
          className="input"
          value={surecTipi}
      ...
      {/* Emisyon Faktörü */}
      <div className="mb-4">
        <label className="block font-medium mb-1">Emisyon Faktörü (opsiyonel)</label>
        <input
          type="number"
          ...
          className="input"
        />
        <small className="text-xs text-gray-500">Boş bırakılırsa varsayılan kullanılacaktır.</small>
      </div>

      {/* Ek Emisyonlar */}
      <div className="mb-6">
        <label className="block font-medium mb-1">Proses Bazlı Ek Emisyonlar (opsiyonel)</label>
